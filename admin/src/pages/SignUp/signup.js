            ...
            <section className='loginSection signUpSection'>
                ...
                <div className='row'>
                    <div className='col-md-8 d-flex align-items-center flex-column part1 justify-content-center'>
                        <h1>BEST UI/UX FASHION <span className='text-sky'>ECOMMERCE DASHBOARD</span> & ADMIN PANNEL</h1>
                        <p>
                                ...
                                <form>
                                    ...
                                    <div className={`form-group position-relative ${inputIndex === 0 && 'focus'}`}>
                                        ...
                                        <input type='text' className='form-control'
                                            placeholder='Enter your name' onFocus={() => focusInput(0)}
                                    ...
                                    <div className={`form-group position-relative ${inputIndex === 1 && 'focus'}`}>
                                        ...
                                        <input type='text' className='form-control'
                                            placeholder='Enter your email' onFocus={() => focusInput(1)}
                                    ...
                                    <div className={`form-group position-relative ${inputIndex === 2 && 'focus'}`}>
                                        ...
                                        <input type={`${isShowPassword === true ? 'text' : 'password'}`} className='form-control'
                                            placeholder='Enter your password' onFocus={() => focusInput(2)}
                                            onBlur={() => setInputIndex(null)} />
                                    ...
                                    <div className={`form-group position-relative ${inputIndex === 3 && 'focus'}`}>
                                        ...
                                        <input type={`${isShowConfirmPassword === true ? 'text' : 'password'}`} className='form-control'
                                            placeholder='Confirm your password' onFocus={() => focusInput(3)}
                                            onBlur={() => setInputIndex(null)} />
                                    ...
                                    <FormControlLabel control={<Checkbox />} label="I agree to he all Terms & Conditions." />
